...
Projeto de uma pokedex criada em angular.

# Funções

Mostra uma lista com 100 pokemons, tem a opção de pesquisa pelo nome, selecionar o pokemon escolhido, ver seu status e estastíticas.
